      ...
      <div className="container-fluid py-5">
          ...
          <div className="row px-xl-5">
              ...
              >
                <div className="carousel-inner border">
                  <div className="carousel-item active">
                      ...
                      <img src={`http://localhost:3001/${sp['imageUrl']}`} alt={sp['name']} className="img-fluid" style={{ width: '100%' }} />
            ...
            <div className="col-lg-7 pb-5">
              <h3 className="font-weight-semi-bold">{sp['name']}</h3>
              <p className="mb-4">
              {sp['discription']}
              </p>
              ...
              <h3 className="font-weight-semi-bold mb-4">${sp['price']}.00</h3>
              <div className="d-flex mb-3">
              ...
              <div className="d-flex align-items-center mb-4 pt-2">
                ...
                <button onClick={() => {dispatch(themSP(sp))}} className="btn btn-primary px-3">
        ...
        <div className="row px-xl-5">
          <div className="col">
            <div className="nav nav-tabs justify-content-center border-secondary mb-4">
              ...
              <Link className="nav-item nav-link" data-toggle="tab" href="#tab-pane-2">
                Information
              </Link>
              <Link className="nav-item nav-link" data-toggle="tab" href="#tab-pane-3">
                Reviews (0)
              </Link>
            </div>
